...
Cancer is bad, of which lung cancer is the worst.

Radiotherapy is a possible treatment, hypofractionated SBRT showed promising result.

Particle therapy is well established, physical & biological advantages. 
Treatment of moving tumors is challenging with active beam scanning.
...
In order to create carbon-ion treatment plans and calculate 4D doses, contours have to be propagated from planning to all states 4D computed tomography (CT) and motion between 4D-CT states has to be quantified. This will be achieved with deformable image registration (DIR). Tools to make DIR on large datasets will be presented. Furthermore, a designated 
