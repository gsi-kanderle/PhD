...
All targets were treated with IMPT and 4D optimization. A subset of motion states 0, 50 and 70\% was used for targets 7a, 7b and 8b (see Table~\ref{tab:patdata2}) due to large optimization problem - beside multiple targets, OAR was also included
...
TRiP je mel boljse rezultate, ampak je se prostor za improvat. Manj voxelov, doza v OAR proti nic in shell around targets to reduce dose.

Robustness 3D in 4D. V 4D so samo razlicne starting phase, treba je prov vse nekak upostevat.

Gating bo verjetno nujen, ker je OAR prevec rizkantn.
