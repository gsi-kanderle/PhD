...
SFUD and indITV used WEPL-ITV as target for optimization, whereas 4Dopt did optimization on CTV with margins in each motion state.
  

The objective for target was 99\% of each tumor volume should receive at least 100\% of the planned dose (D_{99}\% $\geq$ 100\%).


Furthermore, doses to OAR should be under the limits given here \cite{Benedict2010}. 

If the PTV and an OAR (e.g. small airways) overlaped then an OAR with or without margin (1-2 mm) was subtracted from PTV or FTV, to satisfy OAR constraints.
