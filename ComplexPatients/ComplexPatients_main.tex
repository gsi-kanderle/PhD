...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|}
		\hline\hline
		\multirow{2}{*}{Patient} & \multirow{2}{*}{Target} & \multicolumn{3}{|c|}{CTV $D_{99\%}$ (\%)}  \\ \cline{3-5}
		 &  & ITV & 4Dopt & SBRT \\
		 \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\multirow{2}{*}{OAR} &  ITV & 4Dopt & SBRT \\ \cline{2-4}
...
\hline\hline
& \multicolumn{3}{c|}{$D_{Threshold}$ (\%)} \\ \cline{2-4}
% \hline
...
\hline\hline
& \multicolumn{3}{c|}{$V_{20\%}$ (\%)} \\\cline{2-4}
% \hline
