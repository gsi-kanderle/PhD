...
The energy loss of ions is proportional to $z_{eff}$ and inversely proportional to $v^2$. The shape of the curve in figure \cite{ddp} can now be understood. Ions enter the matter with a high velocity,
...
\subsubsection{Lateral scattering of ions}
\label{scat}
As mentioned in section \cite{iion} ions interact mostly via electronic stopping at energies used in radiotherapy. However, nuclear stopping still occurs and it is the main reason for lateral scattering.
