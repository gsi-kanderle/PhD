...
\setlength{\itemsep}{-\parsep}
  ...
  \acro{CVI,CTI}{cavotricuspid isthmus}
  \acro{DKFZ}{German cancer research center}
  ...
  \acro{nSID}{normalized specific integral dose}
  ...
  \acro{SID}{specific integral dose}
  \acro{SOBP}{spread out Bragg peak}
  \acro{SSB}{single strand breaks}
  \acro{SVC}{superior vena cava}
  \acro{TRiP}{TReatment planning for Particles}
\end{acronym}
\onecolumn
