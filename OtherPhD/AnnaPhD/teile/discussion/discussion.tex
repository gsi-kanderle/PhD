...
(chapters \ref{chapter:mdacc} and \ref{chapter:humans}). In preparation for animal studies, which will be carried out at GSI in 2014, the 
...
in order to induce fibrotic tissue \cite{Faj70} \cite{Faj73} \cite{Phi64} \cite{Bis65} \cite{Ste68} \cite{Efs56}.\newline
\newline
...
Other studies by Phillips et al. \cite{Phi64} and Bishop et al. \cite{Bis65} irradiated hearts of dogs and rodents with single photon doses 
...
optimization process. Two different IMPT(OAR) settings were used. One which was planned to deposit not more than a maximal dose of 17.5Gy 
...
are pre-irradiations with small doses in the order of mGy \cite{Ben12} and the usage of in-beam PET monitoring with a probing beam \cite{Fie10} 
...
for an addiational antiarrhthmic effect. The clinical relevance of these findings nneds to be investigated.\newline
\newline
...
range variations \cite{Gra12}. The IMPT plans were computed with three beam channel directions (see chapter \ref{chapter:human}). The CTV 
...
\subfigure[Patient 2 : photons (IMRT)]{
 \includegraphics[scale=0.4]{Pat05_Amanda.png}
 }
 \subfigure[Patient 2 : carbon ions (IMPT)]{
   \includegraphics[scale=0.4]{Pat05_carbon.png}}
\subfigure[Patient 4 : photons (IMRT)]{
 \includegraphics[scale=0.4]{Pat08_Amanda.png}}
 \subfigure[Patient 4 : carbon ions (IMPT)]{
  \includegraphics[scale=0.4]{Pat08_carbon.png}}
...
% \tiny
  ...
  \begin{tabular}{|c|c||c|c|c||c|c|c||c|}
    ...
    & Heart & 15 & 16 & Pericarditis & 27.1 & 25 & 25.3 & (15.8) \\
    ...
    & Heart & 15 & 16 & Pericarditis & 26.1 & 20.5 & 16.8 & (22.3) \\
...
\subfigure[Patient 2 : carbon ions (IMPT)]{
 \includegraphics[scale=0.46]{Pat05_DVH_carbon_withLegend.png}
 }
\subfigure[Patient 4 : photons (IMRT)]{
 \includegraphics[scale=0.46]{Pat08_DVH_Amanda_forLegend.png}
 }
\subfigure[Patient 4 : carbon ions (IMPT)]{
 \includegraphics[scale=0.46]{Pat08_DVH_carbon_withLegend.png}
 } 
 \end{center}
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c||c||c|c|}
    ...
    & Trachea & 81 & 57 & 48 \\
    & Aorta & 983 & 388 & 356 \\
    & Heart & 13,863 & 2,340 & 2,123 \\
    & Lung & 10,932 & 4,761 & 4,326 \\
    \hline
    5 & Esophagus & 166 & 81 & 32 \\
    & Trachea & 20 & 0 & 0 \\
    & Aorta & 912 & 264 & 180 \\
    & Heart & 6,992 & 1,029 & 874 \\
...
\subfigure[Pig 3 : photons (IMRT)]{
 \includegraphics[scale=0.38]{L976_IMRT_Limin.png}
 }
 \subfigure[Pig 3 : carbon ions (SFUD)]{
   \includegraphics[scale=0.38]{L976_carbon.png}
   }
...
\begin{center}
\subfigure[Pig 1]{
 \includegraphics[scale=0.52]{L829_DVH.png}
 }
\subfigure[Pig 2]{
 \includegraphics[scale=0.52]{L833_DVH.png}
 }
\subfigure[Pig 3]{
 \includegraphics[scale=0.52]{L976_DVH.png}
 }
\subfigure[Pig 4]{
 \includegraphics[scale=0.52]{L979_DVH.png}
 } 
 \end{center}
...
esophagus in red, to the trachea in green, the aorta in blue and the irradiated heart (with the substracted the ITV bolume of the AV node) is 
...
a much smaller absolute mean displacement of (6.76 $\pm$ 3.57)mm and (6.76 $\pm$ 2.51) was found in the here studied patient cohort for LPV 
and RPV, respectively. The SI motion was the biggest motion direction with a mean displacement of (-6.41 $\pm$ 3.80)mm for LPV 
and (-6.57 $\pm$ 2.42)mm for RPV. AP and LR directions were almost negligible with a mean motion of less than 2mm. 
...
patients studied by Ector et al.. Nevertheless it should be noted that both analysis are based on a small patient number of nine patients 
compared to sixteen patients.\newline
\newline
...
\bibitem[Ami06]{Ami06}{Amino M, Yoshioka K, Tanabe T, Tanaka E, Mori H, Furusawa Y, Zareba W, Yamazaki M, Nakagawa H, Honjo H, Yasui K, Kamiya K, Kodama I: Heavy ion radiation up-regulates Cx43 and ameliorates arrhythmogenic substrates in hearts after myocardial infarction; Cardiovascular Research; 72; 412?421; 2006}
\bibitem[Ami10]{Ami10}{Amino M, Yoshioka K, Fujibayashi D, Hashida T, Furusawa Y, Zareba W, Ikari Y, Tanaka E, Mori H, Inokuchi S, Kodama I, Tanabe T: Year-long upregulation of connexin43 in rabbit hearts by heavy ion irradiation; Am J Physiol Heart Circ Physiol; 298; 2010.}
...
\bibitem[Faj73]{Faj73}{Fajardo, LF and Stewart JR: Pathogenesis of radiation-induced myocardial fibrosis; Laboratory Investigations; 29; 1973}
 \bibitem[Fie10]{Fie10}{Fiedler F, Shakirin G, Skowron J, Braess H, Crespo P, Kunath D, Pawelke J, Pönisch F, Enghardt W: On the effectiveness of ion range determination from in-beam PET data; Phys Med Biol; 55(7); 2010}
...
% %  \bibitem[Jaek01]{Jaek01}{J\"akel O, Jacob C, Schardt D, Karger CP, and Hartmann GH: Relation between carbon ion ranges and x-ray CT numbers; American Association of Physicists in Medicine; 2001}
 \bibitem[Kan04]{Kan04}{Kanagaratnam P, Cherian A, Stanbridge RD, Glenville B, Severs NJ, Peters NS: Relationship between connexins and atrial activation during human atrial fibrillation; J Cardiovasc Electrophysiol; 15; 206?216; 2004}
 ...
 \bibitem[Sev04]{Sev04}{Severs NJ, Coppen SR, Dupont E, Yeh H-I, Ko Y-S, Matsushita T: Gap junction alterations in human cardiac disease; Cardiovascular Research; 62; 368?377; 2004}
 \bibitem[Sev08]{Sev08}{Severs NJ, Bruce AF, Dupont E and Rothery S: Remodelling of gap junctions and connexin expression in diseased myocardium; Cardiovascular Research; 80; 9?19; 2008}
...
\bibitem[Dar13]{Dar13}{Darby SC, Ewertz M, McGale P, Bennet AM, Blom-Goldman U, Br$\o$nnum D, Correa C, Cutter D, Gagliardi G, Gigante B, Jensen MB, Nisbet A, Peto R, Rahimi K, Taylor C, Hall P: Risk of ischemic heart disease in women after radiotherapy for breast cancer; N Engl J Med.; 368(11); 2013}
\bibitem[Mar98]{Mar98}{Martel MK, Sahijdak WM, Ten Haken RK, Kessler ML, Turrisi AT: Fraction size and dose parameters related to the incidence of pericardial effusions; Int J Radiat Oncol Biol Phys.; 40(1); 1998}
 ...
 \bibitem[Lic05]{Lic05}{Lickfett L, Dickfeld T, Kato R, Tandri H, Vasamreddy CR, Berger R, Bluemke D, Lüderitz B, Halperin H, Calkins H: Changes of pulmonary vein orifice size and location throughout the cardiac cycle: dynamic analysis using magnetic resonance cine imaging; J Cardiovasc Electrophysiol.; 16(6); 2005}
