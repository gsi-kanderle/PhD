...
% The PT is able to create sharp gradients and hence irradiate less normal tissue. 
...
%In total treatment plans for 23 NSCLC patients were generated, with three different optimization strategies - a single-field uniform optimization (SFUD), IMPT with field-independent ITV 
%and 4D IMPT optimization. All three techniques delivered sufficient target dose over a set of 4 different breathing motions.
