...
The treatment of NSCLC with PT is influenced by interplay between the tumor motion and the beam scanning. It was shown that rescanning offers
...
In this study, DIR was used for contour propagation and 4D dose calculations. The 4D dose calculation requires 
accurate DIR in each voxel, since the dose is propagated with vector field. This was ensured by calculating the vector field Jacobian and ICE voxel-wise. 
...
Scanned carbon-ions (PT) should be considered as a treatment modality for the non-small cell lung cancer. Beside delivering 
...
smaller than with SBRT. This could play a crucial role in some patients, for which PT could deliver a dose in a single fraction, where SBRT is limited due to over 
...
Standard geometrical margin definition may be inadequate in PT, while the robust optimization can substantially improve the treatment plans \cite{Chen2012}. 
The robustness optimization is now computationally possible even for a 4D optimization \cite{Liu2016}, bringing treatment of lung cancer patients with PT closer to reality.
...
This could be achieved by combining MRI and Linac and first patients will be treated in the near future \cite{Lagendijk2016}. This will have an important effect on the radiation therapy.
For PT the challenge of combining it with MRI may be even greater than for photons, however studies have shown feasibility of a such combination \cite{Hartman2015}.
...
Patients with an advanced stage of lung cancer have an extremely poor prognosis, with a median survival of only nine months. 
