...
DIR resulting from 4D-CTs play an essential in these studies. It was used in contour propagation to estimate and mitigate tumor motion. In addition DIR was also used in 4D dose calculation.

The second set of data were pig cardiac 4D-CTs. They were also used in treatment planning as a part of an animal study, conducted at GSI. 4D-CT DIR was also used for contour propagation and 4D dose calulation. However, the treatment plans were than actual used for animal irradiation. It was therefore necesarry not only to obtain DIR, but also to ensure its quality.

The DIR were calculated as explained in Section . Afterwards absolute difference, Jacobian and ICE were calculated as part of the DIR.

\subsection{Registration of lung 4D-CT patient data}
\label{lungDIR}

The effects of interplay between tumor motion and active beam scanning can drastically change the dose distribution for PT. It is therefore neccessary to estimate tumor motion and employ designated motion mitigation techniques.

Chapters \ref{PatStudy} and \ref{chapter:complex} present studies on simulating active scanning carbon ion treatment for non-small cell lung cancer patients. The studies included patient data of 23 lung cancer patients. In order to calculate realistic treatment plans, 4D-CT data were used. All 4D-CT were registered to estimate tumor motion and to calculate 4D dose. To ensure the DIR quality, DIRQA was performed on all DIR.
...
In itself it is not a life threatening, however it worsens the patient's quality of life and increases the risk of a stroke \cite{Benjamin1998}. 
A common method for treating atrial fibrillation is catheter ablation \cite{January2014}. The success rate of a catheter ablation is still limited and 
...
To estimate and compensate motion of the heart during irradiation DIR of 4D-CT data was required. Furthermore, because of the actual irradiation of live pigs a DIR quality had to be estimated.
