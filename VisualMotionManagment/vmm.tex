...
and fitted with linear function. Resulting coeficents were \textbf{YES?} for jacobian, inverse jacobian and ICE, respectively and were all statistically significant, with $p < 0.05$. 
