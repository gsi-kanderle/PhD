...
Jacobian and ICE results are shown on Figures \ref{jacobian_data, ICE} and summarized in Table~\ref{tab:dirdata_lung}. Maximum values of jacobian, inverse jacobian and ICE were tested against maximum vector values in superior-inferior direction
...
Values for Jacobian and inverse Jacobian were close to 1 with small STD.
