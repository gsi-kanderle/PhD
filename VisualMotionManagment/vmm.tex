...
For each DIR mean, standard deviation (STD), maximum and minimum were collected for vector field, Jacobian and ICE. Data is presented on Figures \ref{jacobian_data, ice} for vector and inverse vector field, Jacobian of vector and inverse vector field and ICE, respectively.
...
%   \footnotesize
  ...
  \begin{tabular}{c|c|c|c|c|c|c|c|c|c}
       & \multicolumn{3}{|c|}{VF} & \multicolumn{3}{|c|}{IVF} & Jacobian & Inverse VF Jacobian & ICE \\
       & x & y & z & x & y & z & & & \\
        
      \hline
      Mean & 1 & 2 &3 & 1  & 2 & 3 & 0.99 (0.96 - 1.01) & 1.01 (0.99 - 1.03) & 0.43 (0.01 - 1.16)\\
