...
DIR was successfully performed on all 23 patients. An example of planning and 4D DIR is shown on Fig. \textbf{DO IT}. Vector fields resulting from all DIR were analyzed and data is shown in Table~\ref{tab:vectordata_lung}. There was no statistical
