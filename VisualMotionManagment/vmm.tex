...
checks. The main objective of this work was to provide systematic approach to DIR and to give parameters on DIRQA that can estimate the quality of DIR.
...
The evaluation of DIR was made by DIRQA module. The techniques used can be divided into non-quantative (false color, checkerboard) and quantative (absollute difference, Jacobian and ICE). The main
advantage of the DIRQA module is that all different tecniques are gathered in a single place and can be used on a specific case. The ease of use is also essential, for DIRQA to find it's way into clinical workflow.
