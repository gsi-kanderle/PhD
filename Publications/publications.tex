...
\begin{setlength}{\leftmargini}{1.4em}
  ...
  %	PTCOG, 4D Workshop, ESTRO, PTCOG, DGMP, PTCOG (Anna) ESTRO (Sandra)
    ...
    \item[]  Prall1 M., Hild S., \textbf{Anderle K.} and Graeff C. (2016). Treatment Planning with an Adaptive Dose Grid; \texit{PTCOG}. Poster presentation
    \item[]  Eichhorn A., Hild S., \textbf{Anderle K.} and Graeff C. (2016). Speed-up of plan delivery for intensity modulated particle therapy by splitting iso-energy slices according to beam intensity levels; \texit{PTCOG}. Poster presentation
